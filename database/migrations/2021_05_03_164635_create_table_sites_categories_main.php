...
class CreateTableSitesCategoriesMain extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sites_categories_main', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('sites_categories_main');
    }
}
