            ...
            @if(!empty($package))
                ...
                <div class="table-responsive">
                    <table class="table table-default">
                        <thead>
                        <tr>
                            <th>{{__('Website')}} <a wire:click="sort(0, {{ $info->id }}, 'url')" class="sort"><i class="fas fa-sort"></i></a></th>
                            <th>{{__('IP Address')}} <a wire:click="sort(0, {{ $info->id }}, 'subnet')" class="sort"><i class="fas fa-sort"></i></a></th>
                            <th>{{__('PA')}} <a wire:click="sort(0, {{ $info->id }}, 'pa')" class="sort"><i class="fas fa-sort"></i></a></th>
                            <th>{{__('DA')}} <a wire:click="sort(0, {{ $info->id }}, 'da')" class="sort"><i class="fas fa-sort"></i></a></th>
                            <th>{{__('TF')}} <a wire:click="sort(0, {{ $info->id }}, 'tf')" class="sort"><i class="fas fa-sort"></i></a></th>
                            <th>{{__('CF')}} <a wire:click="sort(0, {{ $info->id }}, 'cf')" class="sort"><i class="fas fa-sort"></i></a></th>
                            <th>{{__('DRE')}} <a wire:click="sort(0, {{ $info->id }}, 'dre')" class="sort"><i class="fas fa-sort"></i></a></th>
                        </tr>
                        </thead>
                        <tbody>
    ...
    @elseif($view == 'configuration')
        <div class="package-configuration">
            <div class="table-title">
                <h1 class="mt-0">{{__('Configure links package')}}</h1>
            </div>
            <div class="table-responsive">
                <table class="table table-default">
                    <thead>
                ...
                @foreach($categories as $i => $category)
                    ...
                    <div class="table-responsive">
                        <table class="table table-default">
                            <thead>
                            <tr>
                                <th>{{__('Name')}} <a wire:click="sort({{ $i }}, {{ $category->id }}, 'name')" class="sort"><i class="fas fa-sort"></i></a></th>
                                <th>{{__('Number')}} <a wire:click="sort({{ $i }}, {{ $category->id }}, 'sites')" class="sort"><i class="fas fa-sort"></i></a></th>
                                <th>{{__('PA')}} <a wire:click="sort({{ $i }}, {{ $category->id }}, 'pa')" class="sort"><i class="fas fa-sort"></i></a></th>
                                <th>{{__('DA')}} <a wire:click="sort({{ $i }}, {{ $category->id }}, 'da')" class="sort"><i class="fas fa-sort"></i></a></th>
                                <th>{{__('TF')}} <a wire:click="sort({{ $i }}, {{ $category->id }}, 'tf')" class="sort"><i class="fas fa-sort"></i></a></th>
                                <th>{{__('CF')}} <a wire:click="sort({{ $i }}, {{ $category->id }}, 'cf')" class="sort"><i class="fas fa-sort"></i></a></th>
                                <th>{{__('Total')}} <a wire:click="sort({{ $i }}, {{ $category->id }}, 'total')" class="sort"><i class="fas fa-sort"></i></a></th>
                                <th>{{__('Price')}} <a wire:click="sort({{ $i }}, {{ $category->id }}, 'price')" class="sort"><i class="fas fa-sort"></i></a></th>
                                <th>{{__('Actions')}}</th>
                            </tr>
                            </thead>
                            <tbody>
