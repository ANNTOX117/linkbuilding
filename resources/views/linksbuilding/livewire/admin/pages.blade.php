                    ...
                    <div class="modal-body">
                        <div class="inside-form">
                            ...
                            <div class="form-group">
                                ...
                                <input wire:model="name" type="text" class="form-control" maxlength="120" :errors="$errors" autocomplete="off" />
                                @error('name') <span class="error">{{ $message }}</span> @enderror
                            </div>
                            <div class="form-group">
                                <label for="content" class="form-label">{{__('Content')}} <sup><i class="fas fa-asterisk fa-xs text-danger"></i></sup></label>
