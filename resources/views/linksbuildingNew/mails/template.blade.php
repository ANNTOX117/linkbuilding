		...
		<tr>
			<td bgcolor="#b53471" align="center" style="padding: 0px 10px 0px 10px;">
				<table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px; max-width: 600px; border-right: 3px solid; border-left: 3px solid; border-color: #b53471;">
						...
						@if (!empty(@$icon))
							<tr>
								<td style="padding: 0px 30px 0px 30px; color: #666666; font-family: 'Lato', Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 400; line-height: 25px;" bgcolor="#ffffff" align="center">
						...
						@if (!empty(@$password) && !empty($email))
							<tr>
								<td bgcolor="#ffffff" align="center" style="padding: 10px 30px 10px 30px; color: #666666; font-family: 'Lato', Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 400; line-height: 25px;">
												...
												<table border="0" cellspacing="0" cellpadding="0">
													<tr>
														<td align="center" style="border-radius: 3px;" bgcolor="#18bc9c">
															<a href="{{ @$link }}" target="_blank" style="font-size: 20px; font-family: Helvetica, Arial, sans-serif; text-decoration: none; padding: 15px 25px; border-radius: 2px; color: #B53471; background: #fff; border: 2px solid #B53471;">@lang(@$link_text)</a>
														</td>
													</tr>
												</table>
											</td>
