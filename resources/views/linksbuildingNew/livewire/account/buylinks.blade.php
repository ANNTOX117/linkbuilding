				...
				<div class="col-md-12 p-0">
					<div class="row align-items-start align-items-lg-center">
						<div class="col-12 col-sm-4 col-md-3 col-lg-2">
								...
								{{-- @if($blogactive == 'noshow' && $linkactive == 'noshow' && $startingarticleactive == 'noshow' && $startingpageactive == 'noshow' && $formactive == 'noshow' && $formrequeststartpage == 'noshow' && $formrequestblog == 'noshow')
									<div class="col-lg-auto d-sm-flex align-items-center mb-2 pl-0">
										{{ __('Select language:') }}&nbsp;
										<select wire:model="language" class="form-control select-xs inputs-small ml-sm-2">
											<option value="0">{{__('All')}}</option>
											<option value="2">{{__('Dutch')}}</option>
											<option value="1">{{__('English')}}</option>
											<option value="4">{{__('Spanish')}}</option>
										</select>
									</div>
								@endif --}}
								@if ($tab == 'startpage')
									{{ $table_startpage_link->total() }}
								@endif
								@if ($tab == 'sidebar')
									{{ $table_blog_sidebar_link->total() }}
								@endif
								@if ($tab == 'content')
									{{ $table_blog_content_link->total() }}
								@endif
								@if ($tab == 'article')
									{{ $table_startpage_article->total() }}
								@endif
								@if ($tab == 'blog')
									{{ $table_blog_article->total() }}
								@endif
								{{ __('results found') }}
						</div>
						<div class="col-12 col-sm-8 col-md-9 col-lg-10 tab-mylinks">
							<ul class="nav nav-tabs border-0 pb-lg-2" id="myTab" role="tablist">
								<li class="nav-item col-auto pl-0 pr-1">
									<a class="nav-link @if($tab == 'blog') active @endif" wire:click="table('blog')" data-toggle="tab" href="#blog-article">
										{{ __('Blog content link') }}
									</a>
								</li>
								<li class="nav-item col-auto pl-0 pr-1">
									<a class="nav-link @if($tab == 'sidebar') active @endif" wire:click="table('sidebar')" data-toggle="tab" href="#blog-sidebar-link">
										{{ __('Blog sidebar link') }}
									</a>
								</li>
								<li class="nav-item col-auto pl-0 pr-1">
									<a class="nav-link @if($tab == 'article') active @endif" wire:click="table('article')" data-toggle="tab" href="#startpage-article">
										{{ __('Startpage blog') }}
									</a>
								</li>
								<li class="nav-item col-auto pl-0 pr-1">
									<a class="nav-link @if($tab == 'startpage') active @endif" wire:click="table('startpage')" data-toggle="tab" href="#startpage-link">
										{{ __('Startpage link') }}
									</a>
								</li>
								{{-- justify-content-lg-end<li class="nav-item col-auto pl-0 pr-1">
									<a class="nav-link @if($tab == 'content') active @endif" wire:click="table('content')" data-toggle="tab" href="#blog-content-link">
										{{ __('Blog content link') }}
									</a>
								</li> --}}
							</ul>
					...
					<div class="tab-content py-lg-3" id="myTabContent">
						<div class="tab-pane fade pb-2 py-md-2 @if($tab == 'startpage') show active @endif" id="startpage-link" role="tabpanel" aria-labelledby="startpage-tab">
							...
							<div class="box d-flex flex-column align-items-start">
								<div class="w-100 @if($startingpageactive == 'yesshow') d-none @endif">
									<div class="white-container d-block form-inline mb-3 my-sm-2 w-100">
										<div class="row align-items-end">
											<div class="col-4 col-sm-4 col-md-auto col-lg-auto d-sm-flex align-items-center mb-0">
											{{ __('Per Page:') }}&nbsp;
											<select wire:model="perPage" class="form-control select-xs inputs-small ml-sm-2">
												<option>2</option>
												<option>5</option>
												<option>10</option>
												<option>15</option>
										...
										<div class="col-4 col-sm-4 col-md-auto col-lg-auto text-left ml-auto">
											{{ __('Select language:') }}&nbsp;
											<select wire:model="language" class="form-control select-xs inputs-small ml-sm-2">
												<option value="0">{{__('All')}}</option>
												<option value="2">{{__('Dutch')}}</option>
										...
										<div class="col-4 col-sm-4 col-md-auto col-lg-auto text-center ">
											<input wire:model.debounce.300ms="search" class="form-control w-100 inputs-small" type="text" placeholder="{{__('Search')}}...">
										</div>
										</div>
									</div>
										...
										<table class="table table-default w-100" id="domains_startingpage" style="width: 100%;">
											<thead>
												<tr>
													...
													<th class="table-price" wire:click="sortBy('price')" style="cursor: pointer;">{{ __('Price') }} @include('includes._sort-icon',['field'=>'price'])</th>
													<th>{{ __('Actions') }}</th>
												</tr>
											</thead>
											<tbody>
												@if(count($table_startpage_link) > 0)
													@foreach ($table_startpage_link as $list_sites)
														<tr>
															<td class="text-blue">
																	{{ str_replace('/', '',remove_http($list_sites->url)) }}
																	<div class="form-inline">
																		@if ((floatval($list_sites->price_special) > 0) and (floatval($list_sites->price_special) < floatval($list_sites->price)))
																			...
																			<p class="d-flex align-items-center">
																				<small class="offer bg-success text-white p-2 d-flex align-items-center" role="alert">
																					<i class="fas fa-tags"></i>
																					{{ __('Offer!')}}
																				</small>
																			</p>
																		@endif
																	@if($list_sites->permanent)
																		<p class="d-flex align-items-center align-self-start">
																			<small class="offer bg-success text-white p-2 d-flex align-items-center @if($offer_flag) ml-1 @endif" role="alert"> <apan class="">*</apan> {{ __('Permanent links')}}</small>
																		</p>		
																	@endif
																	</div>
															</td>
										...
										<div class="card-body">
											...
											<div class="row">
												<div class="col-lg-12 form-group">
													...
													<div class="">
														<select class="form-control custom-select" wire:model="section_startingpage" wire:click="changeEvent($event.target.value)">
											...
											<div class="row">
												<div class="col-lg-12 form-group">
													<label class="form-label text-aqua">{{__('Description')}}</label>
													<div>
														<input type="text" id="starting_description" wire:model="starting_description" type="text" class="form-control">
													</div>
													@error('starting_description') <span class="error w-100 pr-3 text-right">{{ $message }}</span> @enderror
												</div>
											</div>
											<div class="row">
											...
											<div class="row">
												<div class="col-lg-12 form-group">
													...
													<div>
														@if($permanent_link_starting != 0)
															<select wire:model="yearstartingpage" class="form-control custom-select" id="yearsstartingpage" disabled >
																<option selected value="-5">{{__('Permanent link')}}</option>
															</select>
														@else
										...
										<div class="card-body">
											...
											<div class="row">
												<div class="col-lg-12 form-group">
													<label class="form-label text-aqua">{{__('Time active')}}</label>
													<div>
														@if($permanent_link_link == 1)
															<select wire:model="yearslink" class="form-control custom-select" id="yearslink" disabled>
																<option selected value="-5">{{__('Permanent link')}}</option>
															</select>
														@else
						...
						<div class="tab-pane fade py-2 @if($tab == 'content') show active @endif" id="blog-content-link" role="tabpanel" aria-labelledby="content-tab">
							...
							<div class="box d-flex align-items-start">
								<div class="w-100 @if($blogactive == 'yesshow') d-none @endif">
									<div class="white-container d-block form-inline my-2">
										<div class="row">
								...
								<div id="showCardBlog" class="{{ $blogactive }}">
									...
									<div class="card card-gray">
										<div class="card-body">
											...
											<div class="row">
												<div class="col-lg-12 form-group">
													<label class="form-label text-aqua">{{__('Content area')}}</label>
													<div>
											...
											<div class="row">
												<div class="col-lg-12 form-group">
													<label class="form-label text-aqua">{{__('Anchor text')}}</label>
													<div>
											...
											<div class="row">
												<div class="col-lg-12 form-group">
													<label class="form-label text-aqua">{{__('Href')}}</label>
													<div>
														<div class="row m-0">
															<div class="col-12 col-md-6 col-lg-8 px-0">
											...
											<div class="row">
												<div class="col-lg-12 form-group">
													...
													<div>
														@if(1)
															<select wire:ignore wire:model="blog_years" class="form-control custom-select" id="blog_years" disabled>
																<option selected value="-5">{{__('Permanent link')}}</option>
															</select>
														@else
								...
								<div id="showStartpageArtitle" class="{{ $startingarticleactive  }}">
									...
									<div class="card card-gray">
										<div class="card-body">
											...
											<div class="row">
												<div class="col-lg-12 form-group">
													<label class="form-label text-aqua">{{__('Category')}}</label>
													<div>
											...
											<div id="content-images" class="row">
												<div class="col-lg-12 form-group">
													<label class="form-label text-aqua">{{__('Image')}}</label>
													<div>
											...
											<div class="row">
												<div class="col-lg-6 form-group">
													<label class="form-label text-aqua">{{__('Page title')}}</label>
													<div>
												...
												<div class="col-lg-6 form-group">
													<label class="form-label text-aqua">{{__('Article URL')}}</label>
													<div>
											...
											<div class="row">
												<div class="col-md-12 form-group">
													<label class="form-label text-aqua">{{ __('Article content')}}</label>
													<div>
											...
											<div class="row">
												...
												<div class="col-lg-6 form-group">
													<label class="form-label text-aqua">{{__('Time active')}}</label>
													<div>
														@if($permanent_link_starting_article == 1)
															<select wire:model="article_starting_years" class="form-control custom-select" id="article_starting_years" disabled>
																<option selected value="-5">{{__('Permanent link')}}</option>
															</select>
														@else
															<select wire:model="article_starting_years" class="form-control custom-select" id="article_starting_years">
																<option value="">{{__('Select the years')}}</option>
																<option value="1">{{__('1 year')}}</option>
																<option value="2">{{__('2 years')}}</option>
																<option value="3">{{__('3 years')}}</option>
								...
								<div id="showCardRequestStartpage" class="{{ $formrequeststartpage }}">
									...
									<div class="card card-gray">
										<div class="card-body">
											...
											<div class="row">
												<div class="col-lg-12 form-group">
													<label for="request_title" class="col-form-label text-aqua">{{__('Title suggestion')}}</label>
													<div>
											...
											<div class="row">
												<div class="col-lg-12 form-group">
													<label class="form-label text-aqua">{{ __('Short description')}}</label>
													<div>
														<div class="mb-3" wire:ignore>
															<div x-data
																x-ref="quillEditor"
											...
											@for($i = 0; $i < $max_links; $i++)
												<div class="row">
													<div class="col-lg-12 form-group">
														<label for="request_text_{{$i}}" class="form-label text-aqua">{{__('Link text')}} {{($i + 1)}} @if($i > 0) <span class="text-muted">({{__('not required')}})</span> @endif</label>
														<div>
												...
												<div class="row">
													<div class="col-lg-12 form-group">
														<label for="request_url_{{$i}}" class="form-label text-aqua">{{__('URL')}} {{($i + 1)}} @if($i > 0) <span class="text-muted">({{__('not required')}})</span> @endif</label>
														<div>
											...
											<div class="row">
												...
												<div class="col-lg-6 form-group">
													<label for="request_price" class="form-label text-aqua">{{__('Price per requested article')}}</label>
													<div>
										...
										<div class="card-body">
											...
											<div class="row">
												...
												<div class="col-lg-6 form-group">
													<label class="form-label text-aqua">{{__('Time active')}}</label>
													<div>
														@if($permanent_link_article == 1)
															<select wire:model="yearsarticle" class="form-control custom-select" id="yearsarticle" disabled>
																<option selected value="-5">{{__('Permanent link')}}</option>
															</select>
														@else
								...
								<div id="showCardRequestBlog" class="{{ $formrequestblog }}">
									...
									<div class="card card-gray">
										<div class="card-body">
											...
											<div class="row">
												<div class="col-lg-12 form-group">
													<label for="request_title" class="form-label text-aqua">{{__('Title suggestion')}}</label>
													<div>
														<input wire:model="request_title" type="text" id="request_title" class="form-control">
													</div>
													@error('request_title') <span class="error w-100 pr-3 text-right">{{ $message }}</span> @enderror
											...
											@for($i = 0; $i < $max_links; $i++)
												<div class="row">
													<div class="col-lg-12 form-group">
														<label for="request2_text_{{$i}}" class="form-label text-aqua">{{__('Link text')}} {{($i + 1)}} @if($i > 0) <span class="text-muted">({{__('not required')}})</span> @endif</label>
														<div>
												...
												<div class="row">
													<div class="col-lg-12 form-group">
														<label for="request2_url_{{$i}}" class="form-label text-aqua">{{__('URL')}} {{($i + 1)}} @if($i > 0) <span class="text-muted">({{__('not required')}})</span> @endif</label>
														<div>
...
<script>
	...
	(function($){
		window.addEventListener('showFormcontent', event => {
			...
			$('#article_starting_years').prop('selectedIndex',0);
		...
		window.addEventListener('changeYearsStartingPage', event => {
			$('#yearsstartingpage').prop('selectedIndex',0);
		});
