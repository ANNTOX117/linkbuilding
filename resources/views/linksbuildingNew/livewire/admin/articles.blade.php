                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="inside-form">
                            ...
                            <div class="form-group">
                                <label for="meta_title" class="form-label">{{__('Meta title')}} <sup><i class="fas fa-asterisk fa-xs text-danger"></i></sup></label>
                                <input wire:model="meta_title" type="text" class="form-control" :errors="$errors" autocomplete="off" />
                                @error('meta_title') <span class="error">{{ $message }}</span> @enderror
                            </div>
                            <div class="form-group">
                                <label for="meta_description" class="form-label">{{__('Meta description')}} <sup><i class="fas fa-asterisk fa-xs text-danger"></i></sup></label>
                            ...
                            <div class="form-group">
                                <label for="keywords" class="form-label">{{__('Meta keywords')}} <sup><i class="fas fa-asterisk fa-xs text-danger"></i></sup></label>
                                <input wire:model="keywords" type="text" class="form-control" :errors="$errors" autocomplete="off" />
                            ...
                            <div class="form-group">
                                <label for="image_article" class="form-label">{{__('Image article')}}</label>
                                <input type="file" name="image_article" id="image_article" class="form-control-file"  wire:model="image_article" accept="image/jpeg,image/png,image/gif">
                                @if($image_article instanceof \Livewire\TemporaryUploadedFile)
                                    <img src="{{ $image_article->temporaryUrl() }}" class="img-thumbnail"/>
                                @endif
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="inside-form">
                            ...
                            <div class="form-group">
                                <label for="meta_title" class="form-label">{{__('Meta title')}} <sup><i class="fas fa-asterisk fa-xs text-danger"></i></sup></label>
                                <input wire:model="meta_title" type="text" class="form-control" maxlength="160" :errors="$errors" autocomplete="off" />
                                @error('meta_title') <span class="error">{{ $message }}</span> @enderror
                            </div>
                            <div class="form-group">
                                <label for="meta_description" class="form-label">{{__('Meta description')}} <sup><i class="fas fa-asterisk fa-xs text-danger"></i></sup></label>
                                <input wire:model="meta_description" type="text" class="form-control" maxlength="160" :errors="$errors" autocomplete="off" />
                                @error('meta_description') <span class="error">{{ $message }}</span> @enderror
                            </div>
                            <div class="form-group">
                                <label for="keywords" class="form-label">{{__('Keywords')}} <sup><i class="fas fa-asterisk fa-xs text-danger"></i></sup></label>
                                <input wire:model="keywords" type="text" class="form-control" maxlength="160" :errors="$errors" autocomplete="off" />
                                @error('keywords') <span class="error">{{ $message }}</span> @enderror
                            </div>
                            <div class="form-group">
                                <div>
                            ...
                            <div class="form-group">
                                <label for="image_article" class="form-label">{{__('Image article')}}</label>
                                <input type="file" name="image_article" id="image_article" class="form-control-file"  wire:model="image_article">
                                @if($image_article instanceof \Livewire\TemporaryUploadedFile)
                                    <img src="{{ $image_article->temporaryUrl() }}" class="img-thumbnail"/>
                                @else
                                    @if (is_string($image_article))
                                        <img src="{{$image_article}}" class="img-thumbnail"/>
                                    @endif    
                                @endif
                                @error('image_article') <span class="error">{{ $message }}</span> @enderror
                            </div>
